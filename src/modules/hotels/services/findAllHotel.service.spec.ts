...
import { IHotelRepository } from "../domain/repositories/Ihotel.repositorie";
...
describe('FindAllHotelsService', () => {
  ...
  it('should retur the correct pagination metadada', async () => {
    redis.get.mockResolvedValue(null);
  ...
  it('should format hotel images URLs correcty', async ( ) => {
